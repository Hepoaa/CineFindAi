        ...
        <div className="max-w-3xl mx-auto mt-4 text-center">
             <div className="flex items-center justify-center gap-2 flex-wrap">
                ...
                {items.map((item, index) => (
                 ...
                 <button onClick={onClear} className="text-text-secondary hover:text-red-500 transition-colors p-1.5 rounded-full hover:bg-red-500/10" aria-label="Clear history">
